...
<body>
<div	id="header"	style="width: 1024px;height: 768px;">
    <div style="background-color:	#4B0082;">
        <h1 style="width: 1024px;height: 100px;margin:0 auto;align-content: center;"	align="center">
            <p font-size: 30px;"> <b>后台管理</b></p>
        </h1>
    </div>
    <div	style="width: 200px;height: 668px;background-color:#C0C0C0;">
